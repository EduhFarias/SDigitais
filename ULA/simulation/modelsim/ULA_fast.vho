...
-- RESULT[0]	=>  Location: PIN_U18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- RESULT[1]	=>  Location: PIN_U17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- RESULT[2]	=>  Location: PIN_AA20,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- RESULT[3]	=>  Location: PIN_Y18,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \SUB|Add0~7_combout\ = (\CONTROLLER~combout\(1) & ((\CONTROLLER~combout\(0) & ((\B~combout\(1)) # (\A~combout\(1)))) # (!\CONTROLLER~combout\(0) & (\B~combout\(1) & \A~combout\(1)))))
...
-- Equation(s):
-- \SUB|Add0~9_combout\ = ((\SUB|Add0~8_combout\ $ (\A~combout\(1) $ (!\SUB|Add0~5\)))) # (GND)
-- \SUB|Add0~10\ = CARRY((\SUB|Add0~8_combout\ & ((\A~combout\(1)) # (!\SUB|Add0~5\))) # (!\SUB|Add0~8_combout\ & (\A~combout\(1) & !\SUB|Add0~5\)))
...
-- Equation(s):
-- \SUB|Add0~12_combout\ = (\CONTROLLER~combout\(1) & ((\CONTROLLER~combout\(0) & ((\B~combout\(2)) # (\A~combout\(2)))) # (!\CONTROLLER~combout\(0) & (\B~combout\(2) & \A~combout\(2)))))
...
-- Equation(s):
-- \SUB|Add0~21_combout\ = (\SUB|Add0~17_combout\) # ((!\CONTROLLER~combout\(1) & \SUB|Add0~19_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \CONTROLLER~combout\(1),
	datab => \SUB|Add0~19_combout\,
	datad => \SUB|Add0~17_combout\,
